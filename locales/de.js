export default {
	...
	landing: {
		...
		hero: {
			...
			feat1Desc: 'Proin auctor quam quis neque pharetra, vel accumsan.',
			feat2Title: 'KARTENBASIERT',
			feat2Desc: 'Proin auctor quam quis neque pharetra, vel accumsan.',
			feat3Title: 'UMFRAGE',
			feat3Desc: 'Proin auctor quam quis neque pharetra, vel accumsan.',
		},
		examples: {
			title: 'Gute Beispiele',
			sub: 'Schau, wofür Partimap gut ist!',
			viewBtn: 'Ansehen →',
			card1Badge: 'Verwaltung',
			card1Title: 'Stadtentwicklungskonsultation',
			card1Desc: 'Sammle Meinungen der Bevölkerung zu geplanten Entwicklungen und zeige das Feedback auf der Karte.',
			card1Link: 'https://www.partimap.eu/p/Demo/0',
			card2Badge: 'Verkehr',
			card2Title: 'Verkehrsumfrage',
			card2Desc: 'Befrage Anwohner zu ihren Mobilitätsgewohnheiten und Verbesserungsbedarfen – präzise auf der Karte.',
			card2Link: 'https://www.partimap.eu/p/Demo/0',
			card3Badge: 'Umwelt',
			card3Title: 'Grünflächenplanung',
			card3Desc: 'Beziehe die Gemeinschaft in die Park- und Grünflächenplanung ein: Standorte markieren und Ideen teilen.',
			card3Link: 'https://www.partimap.eu/p/Demo/0',
			card4Badge: 'Beteiligung',
			card4Title: 'Bedarfsermittlung in der Gemeinschaft',
			card4Desc: 'Eine allgemeine Bürgerbefragung: Finde heraus, was deine Gemeinschaft braucht und wo Veränderungen gewünscht werden.',
			card4Link: 'https://www.partimap.eu/p/Demo/0',
		},
		why: {
			title: 'Warum sollte man es nutzen?',
			sub: 'Proin auctor quam quis neque pharetra, vel accumsan.',
			feat1: 'Einfache Bearbeitung',
			feat1Desc: 'Proin auctor quam quis neque pharetra, vel accumsan. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et ex non tellus ullamcorper congue ut ut ex.',
			...
			feat2Desc: 'Proin auctor quam quis neque pharetra, vel accumsan. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et ex non tellus ullamcorper congue ut ut ex.',
			...
			feat3Desc: 'Proin auctor quam quis neque pharetra, vel accumsan. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et ex non tellus ullamcorper congue ut ut ex.',
			...
			feat4Desc: 'Proin auctor quam quis neque pharetra, vel accumsan. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et ex non tellus ullamcorper congue ut ut ex.',
			...
			feat5Desc: 'Proin auctor quam quis neque pharetra, vel accumsan. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et ex non tellus ullamcorper congue ut ut ex.',
		...
		stats: {
			...
			stat1Desc: 'Proin auctor quam quis neque pharetra, vel accumsan.',
			stat2Value: '105',
			stat2Title: 'EINGEREICHTE KARTENELEMENTE',
			stat2Desc: 'Proin auctor quam quis neque pharetra, vel accumsan.',
			stat3Value: '282',
			stat3Title: 'ANZAHL DER ANTWORTEN',
			stat3Desc: 'Proin auctor quam quis neque pharetra, vel accumsan.',
		},
		showcase: {
			title: 'Unser Stolz',
			desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et ex non tellus ullamcorper congue ut ut ex. Proin auctor quam quis neque pharetra, vel accumsan quam tincidunt.',
			...
			dot5Author: '',
			dot6Title: 'Planung des öffentlichen Nahverkehrs',
			dot6Desc: 'Pendler kartierten überfüllte Haltestellen und Lücken im Netz und lieferten so Grundlagen für die Neugestaltung der Bus- und Straßenbahnlinien in der Region.',
			dot6Author: '',
		},
		news: {
			title: 'Neuigkeiten',
	...
	pricing: {
		...
		introP1: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper.',
		introP2: 'Nullam mattis commodo tempor. In hac habitasse platea dictumst. Mauris semper justo ante, vel interdum mauris scelerisque ac. Sed eu fringilla justo.',
	...
	aboutUs: {
		...
		beliefP1: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
		beliefP2: 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
