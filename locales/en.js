export default {
	...
	landing: {
		...
		examples: {
			title: 'Good Examples',
			sub: 'See what Partimap can do for you!',
			viewBtn: 'View →',
			card1Badge: 'Governance',
			card1Title: 'Urban Development Consultation',
			card1Desc: 'Gather residents\' opinions on planned developments and visualise feedback directly on the map.',
			card1Link: 'https://www.partimap.eu/en/p/DEMO-in-English/0',
			card2Badge: 'Transport',
			card2Title: 'Transport Survey',
			card2Desc: 'Ask locals about their mobility habits and improvement needs — mapped precisely.',
			card2Link: 'https://www.partimap.eu/en/p/DEMO-in-English/0',
			card3Badge: 'Environment',
			card3Title: 'Green Space Planning',
			card3Desc: 'Involve the community in park and green area planning: let them pin locations and share ideas.',
			card3Link: 'https://www.partimap.eu/en/p/DEMO-in-English/0',
			card4Badge: 'Participation',
			card4Title: 'Community Needs Assessment',
			card4Desc: 'A general-purpose participatory survey: find out what your community needs and where they want change.',
			card4Link: 'https://www.partimap.eu/en/p/DEMO-in-English/0',
		},
		why: {
			title: 'Why use it?',
		...
		showcase: {
			...
			dot5Author: '',
			dot6Title: 'Public Transport Planning',
			dot6Desc: 'Commuters mapped overcrowded stops and gaps in the network, informing the redesign of bus and tram routes across the region.',
			dot6Author: '',
		},
		news: {
			title: 'News',
			desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et ex non tellus ullamcorper congue ut ut ex. Proin auctor quam quis neque pharetra, vel accumsan quam tincidunt.',
			news1Title: 'Latest developments',
			...
			news2Title: 'International success',
			news2Desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sodales non nunc at congue. Nulla quis est vitae enim semper lacinia et eget ipsum. Cras elementum ultrices nibh, vitae mollis nisi hendrerit eu. Sed sit amet tincidunt velit. Maecenas ultricies mauris vitae est varius, vitae pulvinar sapien malesuada.',
			news3Title: 'Conference presentation',
	...
	aboutUs: {
		...
		supportNote: 'If you would like to support our work, your donation helps K-Monitor stay independent and keeps PARTIMAP free to use.',
