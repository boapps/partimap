export default {
	...
	landing: {
		...
		examples: {
			...
			card1Desc: 'Vond be a lakosságot a település jövőjét érintő döntések előkészítésébe. A résztvevők térképen jelölhetik meg a problémás helyszíneket, fejlesztési javaslatokat tehetnek, és véleményt mondhatnak a tervezett beruházásokról. A beérkező visszajelzések segítenek jobban megérteni a helyi igényeket és megalapozottabb döntéseket hozni.',
			card1Link: 'https://www.partimap.eu/p/Demo/0',
			card2Badge: 'Közlekedés',
			card2Title: 'Közlekedési kérdőív',
			card2Desc: 'Tudd meg, hogyan közlekednek a helyiek, milyen problémákkal találkoznak, és milyen fejlesztéseket tartanának fontosnak. A válaszadók térképen jelölhetik meg a veszélyes vagy nehezen használható útszakaszokat, például kerékpáros közlekedés során, valamint javaslatokat tehetnek a közlekedési infrastruktúra fejlesztésére.',
			card2Link: 'https://www.partimap.eu/p/Demo/0',
			card3Badge: 'Környezet',
			card3Title: 'Zöldfelület-tervezés',
			card3Desc: 'Vonj be lakosokat a parkok, zöldterületek és közösségi terek fejlesztésébe. A résztvevők térképen jelölhetik meg a fejlesztendő helyszíneket, megoszthatják ötleteiket, és visszajelzést adhatnak a meglévő zöldfelületekről. Így olyan fejlesztések valósulhatnak meg, amelyek valóban a közösség igényeire épülnek.',
			card3Link: 'https://www.partimap.eu/p/Demo/0',
			card4Badge: 'Részvétel',
			card4Title: 'Közösségi igényfelmérés',
			card4Desc: 'Gyűjts helyhez kötött véleményeket, javaslatokat és fejlesztési igényeket egyetlen térképes kérdőívben. A résztvevők konkrét helyszínekhez kapcsolhatják észrevételeiket, így pontos képet kaphatsz arról, hogy hol és milyen változtatásokat szeretne a közösség.',
	...
	pricing: {
		...
		extra: {
			...
			features: [
				...
				'AI-alapú szabadszavas válaszkódolás',
				'Szófelhő-generálás',
				'Fejlett adatvizualizációk és diagramok',
				'Hőtérképek és térbeli sűrűségelemzés',
				'Egyedi kérdőív-design (színek, betűtípusok, logók)',
				'Adatértelmezési és kommunikációs tanácsadás',
				'Eredmények prezentációjának támogatása',
			],
	...
	aboutUs: {
		...
		supportNote: 'Ha szeretnéd támogatni munkánkat, adományoddal hozzájárulhatsz ahhoz, hogy a K-Monitor továbbra is függetlenül működhessen, és a PARTIMAP ingyenesen elérhető maradjon.',
