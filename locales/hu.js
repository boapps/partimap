export default {
	...
	landing: {
		...
		examples: {
			title: 'Jó példák',
			sub: 'Nézd meg, mire jó a Partimap!',
			viewBtn: 'Megnézem →',
			card1Badge: 'Közigazgatás',
			card1Title: 'Városfejlesztési konzultáció',
			card1Desc: 'Gyűjtsd össze a lakosság véleményét a tervezett fejlesztésekről, és jelenítsd meg a visszajelzéseket a térképen.',
			card1Link: 'https://www.partimap.eu/p/Demo/0',
			card2Badge: 'Közlekedés',
			card2Title: 'Közlekedési kérdőív',
			card2Desc: 'Kérdezd meg a helyieket a közlekedési szokásaikról és a fejlesztési igényekről – pontosan, térképen.',
			card2Link: 'https://www.partimap.eu/p/Demo/0',
			card3Badge: 'Környezet',
			card3Title: 'Zöldfelület-tervezés',
			card3Desc: 'Vonjuk be a közösséget a parkok és zöldterületek tervezésébe: jelöljenek be helyszíneket és osszák meg ötleteiket.',
			card3Link: 'https://www.partimap.eu/p/Demo/0',
			card4Badge: 'Részvétel',
			card4Title: 'Közösségi igényfelmérés',
			card4Desc: 'Általános célú részvételi kérdőív: derítsd ki, mire van szüksége a közösségednek, és hol szeretnének változtatni.',
		...
		news: {
			...
			news2Title: 'Nemzetközi siker',
			news2Desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sodales non nunc at congue. Nulla quis est vitae enim semper lacinia et eget ipsum. Cras elementum ultrices nibh, vitae mollis nisi hendrerit eu. Sed sit amet tincidunt velit. Maecenas ultricies mauris vitae est varius, vitae pulvinar sapien malesuada.',
			news3Title: 'Konferencián az alkalmazás',
	...
	pricing: {
		...
		free: {
			name: 'Ingyenes',
			tagline: 'Bárkinek ajánljuk, akinek szüksége van egy kis térképes kérdőívezésre!',
			cta: 'REGISZTRÁCIÓ',
		...
		extra: {
			name: 'Extrás',
			tagline: 'Azoknak, akik nem csupán kérdőívet írnának, de az elemzésben, ábrázolásban és disszeminációban is segítséget kérnek!',
			cta: 'ÉRDEKEL!',
			bannerTitle: 'Lorem ipsum',
			includesTitle: 'Lorem ipsum',
			feat1: 'Lorem ipsum',
	...
	aboutPartimap: {
		...
		shortDesc: 'A PARTIMAP egy ingyenes, könnyen kezelhető és rugalmasan testreszabható, térképes kérdőívező felület, amelyet kutatók, civil szervezetek, önkormányzatok és helyi közösségek egyaránt használhatnak. Lehetővé teszi, hogy a kérdőíves adatgyűjtést térképes megjelenítéssel ötvözve gyűjtsünk visszajelzéseket, véleményeket és helyi tapasztalatokat. A PARTIMAP különösen hasznos központi költségvetésű fejlesztések, központi kérdések vagy közösségi tervezési folyamatok esetében, ahol fontos, hogy az érintettek hangja is megjelenjen, és az eredmények áttekinthető, vizualis és jól értelmezhető formában álljanak rendelkezésre.',
		longTitle: 'Részletesen',
		longDesc: 'Participatory mapping, azaz részvételi térképezés: így nevezik a folyamatot, amelynek révén az érintettek pótolhatatlan tudása beépül a számukra készülő közösségi fejlesztésekbe. A PARTIMAP térképes kérdőívező felülete ahhoz nyújt segítséget, hogy lakosokkal való kapcsolat gyorsabbá, hatékonyabbá és egyszerűbbé váljon. A program regisztráció után ingyenesen használható, saját arculattal látható el és nyílt forráskódjának köszönhetően szabadon továbbfejleszthető. Legyél állami szerv, önkormányzat, vagy helyi érdekérvényesítő csoport - ha egy okos és átlátható megoldást keresel arra, hogyan ismerd meg a környezeted véleményét, próbáld ki a PARTIMAPot és csatlakozz te is a fejlesztéshez!',
		longDescExtra: 'A PARTIMAP nem csupán egy eszköz, hanem egy szemlélet: a közös tervezés, a közös döntéshozatal és a közös felelősség eszköze. Hisszük, hogy a helyi tudás és a lakossági visszajelzések beépítése jobb, fenntarthatóbb és elfogadottabb fejlesztéseket eredményez.',
	},
	helpPage: {
		title: 'Súgó',
		topics: 'Témák',
