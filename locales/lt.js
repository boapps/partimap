export default {
	...
	pricing: {
		...
		free: {
			...
			details: 'Su Basic planu iškart po registracijos galite kurti savo žemėlapiais grįstas apklausas, pritaikyti jų išvaizdą ir neribotai rinkti atsakymus. Dėl atvirojo kodo ir išsamios pagalbos galite pradėti savarankiškai, be jokio organizacinio užnugario.',
		},
		extra: {
			name: 'Plus',
			...
			details: 'Su Plus planu mūsų ekspertai lydi jus per visą procesą: padedame suformuluoti klausimus, sukonfigūruoti žemėlapio elementus, o vėliau išanalizuoti surinktus duomenis ir juos pateikti patraukliai bei suprantamai. Tai idealus pasirinkimas, jei rezultatus norite panaudoti sprendimams priimti ar komunikacijai.',
		},
	},
	aboutUs: {
		title: 'About Us',
		beliefTitle: 'What we believe in',
		beliefP1: 'Nuo 2007 m. K-Monitor kovoja už skaidrų viešųjų lėšų naudojimą ir korupcijos mažinimą. Mūsų pilietinės visuomenės organizacija siekia sukurti tokią politinę, ekonominę ir socialinę aplinką, kurioje piliečiai atmeta korupciją, o institucijos ją veiksmingai atskleidžia ir baudžia. Esame įsitikinę, kad skaidrumas tampa tikra jėga tik tuomet, kai piliečiai aktyviai dalyvauja bendruomenės sprendimuose, todėl ir sukūrėme PARTIMAP – kad dalyvavimo procesai taptų prieinamesni visiems.',
