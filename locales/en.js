export default {
	...
	landing: {
		...
		examples: {
			...
			card1Desc: 'Involve residents in preparing decisions that affect the future of your town. Participants can mark problem locations on the map, make development proposals and share their opinion on planned investments. The feedback you receive helps you better understand local needs and make more informed decisions.',
			card1Link: 'https://www.partimap.eu/en/p/DEMO-in-English/0',
			card2Badge: 'Transport',
			card2Title: 'Transport Survey',
			card2Desc: 'Find out how locals get around, what problems they run into and what improvements they would consider important. Respondents can mark dangerous or hard-to-use road sections on the map — for example while cycling — and make proposals for developing the transport infrastructure.',
			card2Link: 'https://www.partimap.eu/en/p/DEMO-in-English/0',
			card3Badge: 'Environment',
			card3Title: 'Green Space Planning',
			card3Desc: 'Involve residents in developing parks, green areas and community spaces. Participants can mark the locations to be improved on the map, share their ideas and give feedback on existing green spaces. This way you can deliver developments that are truly built on the needs of the community.',
			card3Link: 'https://www.partimap.eu/en/p/DEMO-in-English/0',
			card4Badge: 'Participation',
			card4Title: 'Community Needs Assessment',
			card4Desc: 'Collect location-based opinions, proposals and development needs in a single map-based survey. Participants can link their observations to specific locations, so you get an accurate picture of where and what kind of changes the community wants.',
		...
		partners: {
			title: 'Our clients',
			desc: 'PARTIMAP has already been successfully used by numerous national and international organisations: alongside local community actors, local governments and civil society organisations (NGOs), businesses and companies also use it for decision support, research and strategic planning.',
		},
		funding: {
	...
	pricing: {
		...
		free: {
			...
			details: 'With the Basic plan you can create your own map-based surveys immediately after registering, customise their look and collect responses without limit. Thanks to the open source code and the detailed help, you can get started on your own, without any organisational background.',
		},
		extra: {
			name: 'Plus',
