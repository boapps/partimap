export default {
	...
	landing: {
		...
		examples: {
			title: 'Buenos ejemplos',
			sub: '¡Mira para qué sirve Partimap!',
			viewBtn: 'Ver →',
			card1Badge: 'Administración',
			card1Title: 'Consulta de desarrollo urbano',
			card1Desc: 'Recoge opiniones de los residentes sobre los desarrollos planificados y muestra el feedback en el mapa.',
			card1Link: 'https://www.partimap.eu/p/Demo/0',
			card2Badge: 'Transporte',
			card2Title: 'Encuesta de transporte',
			card2Desc: 'Pregunta a los vecinos sobre sus hábitos de movilidad y necesidades de mejora, reflejados en el mapa.',
			card2Link: 'https://www.partimap.eu/p/Demo/0',
			card3Badge: 'Medio ambiente',
			card3Title: 'Planificación de zonas verdes',
			card3Desc: 'Involucra a la comunidad en la planificación de parques y zonas verdes: que señalen lugares y compartan ideas.',
			card3Link: 'https://www.partimap.eu/p/Demo/0',
			card4Badge: 'Participación',
			card4Title: 'Evaluación de necesidades comunitarias',
			card4Desc: 'Una encuesta participativa de uso general: descubre qué necesita tu comunidad y dónde quieren cambios.',
		...
		showcase: {
			...
			dot5Author: '',
			dot6Title: 'Planificación del transporte público',
			dot6Desc: 'Los usuarios habituales señalaron las paradas saturadas y las lagunas de la red, sirviendo de base para el rediseño de las rutas de autobús y tranvía de la región.',
			dot6Author: '',
		},
		news: {
			title: 'Noticias',
	...
	pricing: {
		...
		extra: {
			...
			features: [
				...
				'Codificación de respuestas de texto libre basada en IA',
				'Generación de nubes de palabras',
				'Visualizaciones de datos y gráficos avanzados',
				'Mapas de calor y análisis de densidad espacial',
				'Diseño de encuesta personalizado (colores, fuentes, logotipos)',
	...
	aboutUs: {
		...
		supportNote: 'Si quieres apoyar nuestro trabajo, tu donación ayuda a que K-Monitor siga siendo independiente y a que PARTIMAP siga siendo gratuito.',
