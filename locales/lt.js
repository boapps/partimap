export default {
	...
	landing: {
		...
		examples: {
			...
			viewBtn: 'Peržiūrėti →',
			card1Badge: 'Valdžia',
			card1Title: 'Miesto plėtros konsultacija',
			card1Desc: 'Rinkite gyventojų nuomones apie planuojamus projektus ir pateikite atsiliepimus žemėlapyje.',
			card1Link: 'https://www.partimap.eu/p/Demo/0',
			card2Badge: 'Transportas',
			card2Title: 'Transporto apklausa',
			card2Desc: 'Klauskite vietos gyventojų apie jų judėjimo įpročius ir pagerinimo poreikius – tiksliai žemėlapyje.',
			card2Link: 'https://www.partimap.eu/p/Demo/0',
			card3Badge: 'Aplinka',
			card3Title: 'Žaliųjų plotų planavimas',
			card3Desc: 'Įtraukite bendruomenę į parkų ir žaliųjų zonų planavimą: tegul pažymi vietas ir dalijasi idėjomis.',
			card3Link: 'https://www.partimap.eu/p/Demo/0',
			card4Badge: 'Dalyvavimas',
			card4Title: 'Bendruomenės poreikių tyrimas',
			card4Desc: 'Bendroji dalyvavimo apklausa: sužinokite, ko reikia jūsų bendruomenei ir kur norima pokyčių.',
		...
		showcase: {
			...
			dot5Author: '',
			dot6Title: 'Viešojo transporto planavimas',
			dot6Desc: 'Keleiviai žemėlapyje pažymėjo perpildytas stoteles ir tinklo spragas, taip padėdami pertvarkyti regiono autobusų ir tramvajų maršrutus.',
			dot6Author: '',
		},
		news: {
			title: 'Naujienos',
	...
	pricing: {
		...
		extra: {
			...
			features: [
				...
				'DI pagrįstas laisvo teksto atsakymų kodavimas',
				'Žodžių debesų generavimas',
				'Išplėstinės duomenų vizualizacijos ir diagramos',
				'Šilumos žemėlapiai ir erdvinė tankio analizė',
				'Individualus apklausos dizainas (spalvos, šriftai, logotipai)',
