export default {
	...
	landing: {
		...
		examples: {
			...
			card1Desc: 'Involucra a la ciudadanía en la preparación de las decisiones que afectan al futuro del municipio. Los participantes pueden marcar en el mapa los lugares problemáticos, hacer propuestas de desarrollo y opinar sobre las inversiones previstas. Las opiniones recibidas ayudan a comprender mejor las necesidades locales y a tomar decisiones más fundamentadas.',
			card1Link: 'https://www.partimap.eu/p/Demo/0',
			card2Badge: 'Transporte',
			card2Title: 'Encuesta de transporte',
			card2Desc: 'Descubre cómo se desplazan los vecinos, con qué problemas se encuentran y qué mejoras considerarían importantes. Las personas que responden pueden marcar en el mapa los tramos peligrosos o difíciles de usar, por ejemplo al circular en bicicleta, y hacer propuestas para mejorar la infraestructura de transporte.',
			card2Link: 'https://www.partimap.eu/p/Demo/0',
			card3Badge: 'Medio ambiente',
			card3Title: 'Planificación de zonas verdes',
			card3Desc: 'Involucra a los vecinos en el desarrollo de parques, zonas verdes y espacios comunitarios. Los participantes pueden marcar en el mapa los lugares que deben mejorarse, compartir sus ideas y dar su opinión sobre las zonas verdes existentes. Así pueden llevarse a cabo desarrollos que se basan realmente en las necesidades de la comunidad.',
			card3Link: 'https://www.partimap.eu/p/Demo/0',
			card4Badge: 'Participación',
			card4Title: 'Evaluación de necesidades comunitarias',
			card4Desc: 'Recoge opiniones, propuestas y necesidades de desarrollo vinculadas a lugares en un único cuestionario basado en mapas. Los participantes pueden asociar sus observaciones a lugares concretos, de modo que obtengas una imagen precisa de dónde y qué cambios desea la comunidad.',
	...
	pricing: {
		...
		free: {
			...
			details: 'Con el plan Basic puedes crear tus propias encuestas cartográficas inmediatamente después de registrarte, personalizar su aspecto y recoger respuestas sin límite. Gracias al código abierto y a la ayuda detallada, puedes empezar por tu cuenta, sin ningún respaldo organizativo.',
		},
		extra: {
			name: 'Plus',
