export default {
	...
	pricing: {
		...
		free: {
			name: 'Free',
			tagline: 'Recommended to anyone who needs a bit of map-based surveying!',
			cta: 'REGISTER',
			bannerTitle: 'Lorem ipsum',
			includesTitle: 'Lorem ipsum',
			feat1: 'Lorem ipsum',
			feat2: 'Lorem ipsum',
			feat3: 'Lorem ipsum',
		...
		extra: {
			name: 'Extra',
			tagline: 'For those who don\'t just want a survey, but also need help with analysis, visualization and dissemination!',
			cta: 'I\'M INTERESTED!',
			bannerTitle: 'Lorem ipsum',
			includesTitle: 'Lorem ipsum',
			feat1: 'Lorem ipsum',
